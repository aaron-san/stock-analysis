...
backtestBacktestUI <- function(id, ticker_choices, monthly_rets) {
    ns <- NS(id)
...
backtestBacktestServer <- function(id, asset_rets, cash_rets) {
    moduleServer(id,
